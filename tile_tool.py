...
class TileTool(Tool):
    ...
    def create_windows(self):
        ...
        self.main_window.split_children[0].add_widget(ButtonWidget("export_data", "Export"))
        self.main_window.split_children[0].add_widget(SameLineWidget(10))
        self.main_window.split_children[0].add_widget(ButtonWidget("load_data", "Load"))

        self.main_window.split_children[1].draw_line = False

        new_splits = self.main_window.split_children[1].add_split(SplitType.HORIZONTAL, 170, True)

        tile_list_section = new_splits[0]

        split_tile_list_section = tile_list_section.add_split(SplitType.VERTICAL, 40, False)

        tile_list_title = split_tile_list_section[0]
        ...
        tile_list = split_tile_list_section[1]
        ...
        new_splits[0].split_line_colour = (4, 90, 66)
        new_splits[1].split_line_colour = (4, 90, 66)

        split_tile_properties_section = new_splits[1].add_split(SplitType.VERTICAL, 40, False)

        tile_properties_title = split_tile_properties_section[0]
        ...
        tile_properties = split_tile_properties_section[1]
